CREATE TABLE account (
    ...
    preferred_unit VARCHAR(8) NOT NULL DEFAULT 'METRIC',
...
CREATE TABLE profile (
    ...
    body_type VARCHAR(30) NOT NULL DEFAULT 'UNSPECIFIED',
    eye_colour VARCHAR(30) NOT NULL DEFAULT 'UNSPECIFIED',
    hair_colour VARCHAR(30) NOT NULL DEFAULT 'UNSPECIFIED',
    weight INTEGER NULL,
    height INTEGER NULL,
    ethnicity VARCHAR(30) NOT NULL DEFAULT 'UNSPECIFIED',
    religion VARCHAR(30) NOT NULL DEFAULT 'UNSPECIFIED',
    education VARCHAR(30) NOT NULL DEFAULT 'UNSPECIFIED',
    salary VARCHAR(30) NOT NULL DEFAULT 'UNSPECIFIED',
    smoker TINYINT(1) NOT NULL DEFAULT 0,
    driving_licence TINYINT(1) NOT NULL DEFAULT 0,
    alcohol_drinker TINYINT(1) NOT NULL DEFAULT 0,
    children TINYINT(1) NOT NULL DEFAULT 0,
    young_children TINYINT(1) NOT NULL DEFAULT 0,
